...
function ContactComponent() {
  ...
  return (
    <>
      <CommonNavbar />
      <div className="flex items-center justify-between w-[80%] mx-auto pt-10">
        <div className="p-1 left-side mt-4 rounded-lg">
          <h1 className="head-text text-gray-300 text_gradient">
            Contact info
          </h1>
          <p className="text-gray-300 mt-3 p-2 pr-5">
            Empowering Seamless Transactions: Transforming Supply Chains with
            Blockchain Innovation.Reach out to us for efficient, transparent,
            and secure supply chain solutions that redefine industry standards.
          </p>
        ...
        <div className="right-side text-left">
          {loading ? (
            ...
            <section className="relative flex lg:flex-row flex-col align-center max_container2 mt-4">
