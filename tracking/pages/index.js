...
const index = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className={`flex md:flex-row flex-col gap-2 sm:py-0 sm:px-2 xl:px-10 px-2 py-2 mt-3 w-[90%] mx-auto`}
      >
        <div
        ...
        >
          ...
          <h1 className="font-poppins md:font-semibold ss:text-[52px] text-[35px] text-white ss:leading-[100.8px] sm:leading-[47px] w-full sm:font-light">
