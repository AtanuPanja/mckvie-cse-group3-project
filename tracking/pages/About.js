...
const about = () => {
  ...
  const ImageSection = ({ imageSrc, title, description }) => {
    return (
      <div className="relative group bg-gray-500">
        <img
          src={imageSrc}
          alt={title}
  ...
  return (
    <>
      <CommonNavbar />
      <div className="app-container bg-black-bg w-[90%] mx-auto">
                  ...
                  <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
                    <div className="flex flex-col mb-10 lg:items-start items-center">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="leading-relaxed text-gray-300">
                          Streamline inventory levels and reduce carrying costs
                          by implementing real-time tracking and automation,
                          ensuring optimal stock levels at each stage of the
                          supply chain.
                        </p>
                        <a
                    ...
                    <div className="flex flex-col mb-10 lg:items-start items-center">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="leading-relaxed text-gray-300">
                          ...
                          providing stakeholders with real-time insights into
                          the movement of goods, inventory levels, and
                          production status for better decision-making.
                        </p>
                        <a
                          target="_blank"
                    ...
                    <div className="flex flex-col mb-10 lg:items-start items-center">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="leading-relaxed text-gray-300">
                          Optimize transportation routes, minimize lead times,
                          and enhance overall distribution efficiency by
                          leveraging advanced analytics, route planning, and
                          technology integration within the supply chain
                          network.
                        </p>
                  ...
                  <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
                    ...
                    <div className="flex flex-col mb-10 lg:items-start items-center">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="leading-relaxed text-gray-300">
                          Implementation of self-executing smart contracts on
                          the Ethereum blockchain, automating and enforcing
                    ...
                    <div className="flex flex-col mb-10 lg:items-start items-center">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="leading-relaxed text-gray-300">
                          ...
                          optimizing logistics. There are various ways to
                          optimize your logistics, and deploying modern
                          technology is the best way to do it.
                        </p>
                        <a
                          href="https://packagex.io/blog/goals-of-supply-chain-management "
                          target="blank_"
                  ...
                  <div className="flex flex-wrap -m-12">
                    <div className="p-12 md:w-1/2 flex flex-col items-start">
                      ...
                      <p className="leading-relaxed mb-8">
                        Blockchain ensures transparency by recording and
                        securing every transaction in an immutable ledger. This
                        enables stakeholders to trace the journey of products
                        from origin to destination, providing a transparent view
                    ...
                    <div className="p-12 md:w-1/2 flex flex-col items-start">
                      ...
                      <p className="leading-relaxed mb-8">
                        ...
                        intermediaries, and ensure that contractual agreements
                        are executed automatically when conditions are met.
                      </p>
                      <div className="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
                        <a
                  ...
                  <div className="flex flex-wrap -m-12">
                    <div className="p-12 md:w-1/2 flex flex-col items-start">
                      ...
                      <p className="leading-relaxed mb-8">
                        ...
                        and its associated information are recorded securely.
                        This prevents tampering and counterfeiting, as
                        stakeholders can verify the authenticity of products by
                        accessing the transparent and unchangeable records on
                        the blockchain.
                      </p>
                      <div className="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
                        <a
                    ...
                    <div className="p-12 md:w-1/2 flex flex-col items-start">
                      ...
                      <p className="leading-relaxed mb-8">
                        ...
                        traditional intermediaries. This leads to faster and
                        more cost-effective payment processes, improving
                        liquidity and financial efficiency within the supply
                        chain.
                      </p>
                      <div className="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
                        <a
              ...
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                  ...
                  <p className="leading-relaxed text-gray-300">
                    ...
                    Smart Contract Development: Design and deploy smart
                    contracts to automate and secure transactions within the
                    supply chain. Integration: Integrate blockchain seamlessly
                    into existing supply chain processes and systems.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
              ...
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                  ...
                  <p className="leading-relaxed text-gray-300">
                    Conduct rigorous testing to ensure the reliability,
                    security, and efficiency of the blockchain-based system
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="h-full flex flex-col items-center text-center">
                  ...
                  <div className="w-full">
                    ...
                    <p className="mb-4">
                      ...
                      ensuring each team member was a vital link in the
                ...
                <div className="h-full flex flex-col items-center text-center">
                  ...
                  <div className="w-full">
                    ...
                    <p className="mb-4">
                      ...
                      paradigm shift in efficiency, optimizing routes and
                      reducing lead times, ultimately enhancing the overall
